...
export default function AnalysisPage() {
  ...
  return (
    <main className="h-screen bg-white text-slate-900 font-sans p-3 md:p-4 overflow-hidden flex flex-col relative">
      ...
      <div className="h-[75px] w-full shrink-0"></div>

      <div className="max-w-[1400px] mx-auto w-full relative z-10 flex flex-col flex-1 min-h-0 pt-1">
        ...
        <div className="flex flex-col lg:flex-row gap-4 flex-1 min-h-0 mb-3">
          ...
          >
            {imagePreview && (
              <div className="glass-white p-2 rounded-[28px] shadow-xl border border-orange-100/50 h-full overflow-hidden">
                 <div className="relative h-full rounded-[20px] overflow-hidden border border-slate-100 shadow-inner bg-slate-50">
                   <img src={imagePreview} alt="Crop sample" className="w-full h-full object-cover" />
                   <div className="absolute top-3 left-3">
                      <div className="bg-black/30 backdrop-blur-md px-2 py-1 rounded-lg border border-white/10 text-white font-black text-[8px] uppercase tracking-widest shadow-xl">
                        Subject Evidence
                      </div>
                   </div>
                 </div>
