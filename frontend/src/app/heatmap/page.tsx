  ...
  return (
    <main className="min-h-screen bg-white text-slate-900 font-sans px-4 pb-4 md:px-8 md:pb-8 pt-[120px] md:pt-[140px] flex flex-col items-center relative">
      ...
      <div className="fixed inset-0 pointer-events-none -z-10 overflow-hidden bg-white">
        <div className="absolute top-[-20%] right-[-10%] w-[70%] h-[70%] bg-orange-500/10 rounded-full blur-[150px] animate-pulse"></div>
        <div className="absolute bottom-[-20%] left-[-10%] w-[70%] h-[70%] bg-rose-500/10 rounded-full blur-[150px] animate-pulse delay-1000"></div>
      ...
      <div className="w-full max-w-6xl space-y-4 relative z-10">
        ...
        <div className="bg-white/80 backdrop-blur-md rounded-[32px] p-6 md:p-8 shadow-2xl ring-1 ring-orange-100 mb-8">
